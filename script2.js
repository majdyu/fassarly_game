...
function displayConditions(number) {
    let conditions = [
    { id: "unit-condition", value: isEvenOrOdd(number[5]), text: "رقم الآحاد" }, // Last digit
    { id: "tens-condition", value: isEvenOrOdd(number[4]), text: "رقم العشرات" }, // Second last digit
    { id: "hundreds-condition", value: isEvenOrOdd(number[3]), text: "رقم المئات" }, // Third last digit
    { id: "thousands-condition", value: isEvenOrOdd(number[2]), text: "رقم الآلاف" }, // Fourth last digit
    { id: "ten-thousands-condition", value: isEvenOrOdd(number[1]), text: "رقم عشرات الآلاف" }, // Fifth digit
    { id: "hundred-thousands-condition", value: isEvenOrOdd(number[0]), text: "رقم مئات الآلاف" } // First digit
];
